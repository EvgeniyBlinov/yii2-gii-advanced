...
namespace <?= $generator->nsBase . '\\' . lcfirst($className) ?>;

use Yii;

<?php
    $baseClassDir = pathinfo($generator->baseClass, PATHINFO_DIRNAME);
    if ($baseClassDir != '.'): ?>
...
<?php endif; ?>
 */
class <?= $className ?>Base extends <?=  pathinfo($generator->baseClass, PATHINFO_FILENAME) . "\n" ?>
{
    /**
     * @inheritdoc
     */
